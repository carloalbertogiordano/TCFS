...
\DoxyCodeLine{\Hypertarget{crypt-utils_8c_source_l00005}00005\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{crypt-utils_8h}{crypt-\/utils.h}}"{}}}
\DoxyCodeLine{\Hypertarget{crypt-utils_8c_source_l00006}00006\ }
\DoxyCodeLine{\Hypertarget{crypt-utils_8c_source_l00012}\mbox{\hyperlink{crypt-utils_8c_afcf795f5a96fd55561abe69f56224630}{00012}}\ \textcolor{preprocessor}{\#define\ BLOCKSIZE\ 1024}}
\DoxyCodeLine{\Hypertarget{crypt-utils_8c_source_l00019}\mbox{\hyperlink{crypt-utils_8c_ad7bb30dbf5882fdf05331918e8a0cc84}{00019}}\ \textcolor{preprocessor}{\#define\ IV\_SIZE\ 32}}
\DoxyCodeLine{\Hypertarget{crypt-utils_8c_source_l00025}\mbox{\hyperlink{crypt-utils_8c_a2d996237e082b78b41771b5aa1a6eae1}{00025}}\ \textcolor{preprocessor}{\#define\ KEY\_SIZE\ 32}}
...
\DoxyCodeLine{\Hypertarget{crypt-utils_8c_source_l00054}\mbox{\hyperlink{crypt-utils_8c_a94b5b388b3f00982ccee72b192077e76}{00054}}\ \mbox{\hyperlink{crypt-utils_8c_a94b5b388b3f00982ccee72b192077e76}{do\_crypt}}\ (FILE\ *in,\ FILE\ *out,\ \textcolor{keywordtype}{int}\ action,\ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{char}\ *key\_str)}
...
\DoxyCodeLine{\Hypertarget{crypt-utils_8c_source_l00059}00059\ \ \ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{char}\ inbuf[\mbox{\hyperlink{crypt-utils_8c_afcf795f5a96fd55561abe69f56224630}{BLOCKSIZE}}];}
...
\DoxyCodeLine{\Hypertarget{crypt-utils_8c_source_l00062}00062\ \ \ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{char}\ outbuf[\mbox{\hyperlink{crypt-utils_8c_afcf795f5a96fd55561abe69f56224630}{BLOCKSIZE}}\ +\ EVP\_MAX\_BLOCK\_LENGTH];}
...
\DoxyCodeLine{\Hypertarget{crypt-utils_8c_source_l00070}00070\ \ \ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{char}\ key[\mbox{\hyperlink{crypt-utils_8c_a2d996237e082b78b41771b5aa1a6eae1}{KEY\_SIZE}}];}
\DoxyCodeLine{\Hypertarget{crypt-utils_8c_source_l00071}00071\ \ \ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{char}\ iv[\mbox{\hyperlink{crypt-utils_8c_ad7bb30dbf5882fdf05331918e8a0cc84}{IV\_SIZE}}];}
...
\DoxyCodeLine{\Hypertarget{crypt-utils_8c_source_l00105}00105\ \ \ \ \ \ \ inlen\ =\ fread\ (inbuf,\ \textcolor{keyword}{sizeof}\ (*inbuf),\ \mbox{\hyperlink{crypt-utils_8c_afcf795f5a96fd55561abe69f56224630}{BLOCKSIZE}},\ in);}
...
\DoxyCodeLine{\Hypertarget{crypt-utils_8c_source_l00169}\mbox{\hyperlink{crypt-utils_8c_aa377df016f593aa771013264acc9b86b}{00169}}\ \mbox{\hyperlink{crypt-utils_8c_aa377df016f593aa771013264acc9b86b}{check\_entropy}}\ (\textcolor{keywordtype}{void})}
...
\DoxyCodeLine{\Hypertarget{crypt-utils_8c_source_l00199}\mbox{\hyperlink{crypt-utils_8c_a53b5762e00daafcc3644c03e2fd9b2c4}{00199}}\ \mbox{\hyperlink{crypt-utils_8c_a53b5762e00daafcc3644c03e2fd9b2c4}{add\_entropy}}\ (\textcolor{keywordtype}{void})}
...
\DoxyCodeLine{\Hypertarget{crypt-utils_8c_source_l00232}\mbox{\hyperlink{crypt-utils_8c_a8845f5705eaafda836aac91d5881876f}{00232}}\ \mbox{\hyperlink{crypt-utils_8c_a8845f5705eaafda836aac91d5881876f}{generate\_key}}\ (\textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{char}\ *destination)}
...
\DoxyCodeLine{\Hypertarget{crypt-utils_8c_source_l00240}00240\ \ \ \ \ \ \ \textcolor{keywordtype}{int}\ entropy\ =\ \mbox{\hyperlink{crypt-utils_8c_aa377df016f593aa771013264acc9b86b}{check\_entropy}}\ ();}
...
\DoxyCodeLine{\Hypertarget{crypt-utils_8c_source_l00244}00244\ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{crypt-utils_8c_a53b5762e00daafcc3644c03e2fd9b2c4}{add\_entropy}}\ ();}
...
\DoxyCodeLine{\Hypertarget{crypt-utils_8c_source_l00257}00257\ \ \ \textcolor{keywordflow}{if}\ (\mbox{\hyperlink{crypt-utils_8c_a36c2342a7c47b8f41bf628bf473b1c97}{is\_valid\_key}}\ (destination)\ ==\ 0)}
...
\DoxyCodeLine{\Hypertarget{crypt-utils_8c_source_l00275}\mbox{\hyperlink{crypt-utils_8c_aa926098a8843cf0ab6bd7eb8b3bbd2e6}{00275}}\ \mbox{\hyperlink{crypt-utils_8c_aa926098a8843cf0ab6bd7eb8b3bbd2e6}{encrypt\_string}}\ (\textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{char}\ *plaintext,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *key,}
...
\DoxyCodeLine{\Hypertarget{crypt-utils_8c_source_l00325}\mbox{\hyperlink{crypt-utils_8c_a22f528907ee4f078e333501b747d5435}{00325}}\ \mbox{\hyperlink{crypt-utils_8c_a22f528907ee4f078e333501b747d5435}{decrypt\_string}}\ (\textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{char}\ *ciphertext,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *key)}
...
\DoxyCodeLine{\Hypertarget{crypt-utils_8c_source_l00360}\mbox{\hyperlink{crypt-utils_8c_a36c2342a7c47b8f41bf628bf473b1c97}{00360}}\ \mbox{\hyperlink{crypt-utils_8c_a36c2342a7c47b8f41bf628bf473b1c97}{is\_valid\_key}}\ (\textcolor{keyword}{const}\ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{char}\ *key)}
