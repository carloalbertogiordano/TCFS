...
static char doc[] = "TCFS user accepts one of three arguments: mount, create-shared, or umount.";
...
int main(int argc, char *argv[]) {
    ...
    switch (arguments.operation) {
        ...
        case 3:
            ...
            break;
        default:
            printf("Invalid argument. Choose from 'mount', 'create-shared', or 'umount'.\n");
            return 1;
    }
